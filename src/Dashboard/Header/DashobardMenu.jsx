...
const DashobardMenu = ({ width, setWidth }) => {
                ...
                <ul className={`side-menu dash-w-${sideMenu} ${position}`}>
                    ...
                    <li className="admin-profile">
                        <div className="profile-img">
                            <img src="https://adminlte.io/themes/v3/dist/img/user1-128x128.jpg" alt="web developer" />
                        </div>
