...
const Contact = () => {
    ...
    const map = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14595.316329403484!2d90.38609643347905!3d23.86020227309777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c4285cb21c29%3A0x2a5eb01cd0dd6af9!2s12%20Road-03%2C%20Dhaka%201230!5e0!3m2!1sen!2sbd!4v1704969501482!5m2!1sen!2sbd";
        ...
        <div className='contact'>
            <div className="contact-head relative">
                <div className="container">
                    ...
                    <h3 className='text-white-secondary f-bold font-secondary text-center'>For Any Query</h3>
                </div>
            ...
            <div className='short-contact-section'>
                            ...
                            <div className="contact-details">
                                ...
                                <div className="contact-phone gap-15 item-center">
                                    ...
                                    <div className="numbers">
                                        <a href='tel:+8801796491068' className='font-secondary'>+880 1796 491068</a>
                                    </div>
                                </div>
                                <div className="contact-phone gap-15 item-center">
                                    <div className="add-icon">
                                    ...
                                    <div className="numbers">
                                        <a href='mailto:support@devzoneit.com' className='font-secondary'>support@devzoneit.com</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="w-100">
                    <div className="map">
                        {
                            !map.length ? <ContentLoader /> : <iframe
                                title="Google Maps"
                                src={map}
