...
import img1 from "../../../assets/choose-img-1.png";
        ...
        <div className="heading">
          <div className="flex justify-center item-start">
            ...
            <div className="w-50 choose-banner relative">
              <img src={img1} alt="web developers" />
            </div>
          </div>
        </div>
            ...
            <div className="content-text">
              <div className="main-box">
                ...
                <div className="main-content">
                  ...
                  <p className="text-white-secondary font-primary">
                  ...
                  <div className="absolute content-text-btn">
                    <Link
                      to={"/about"}
                      className="round-btn flex item-center justify-center font-primary"
                    >
                      <svg
                        width="7"
                        height="7"
                ...
                <div className="flex item-center gap-15 justify-start padding">
                  ...
                  <div className="w-80 counter-div-size">
                    <div className="count-content">
                      ...
                      <p
                        style={isOpen ? null : paragap}
                        className="text-white-secondary font-secondary"
                      >
