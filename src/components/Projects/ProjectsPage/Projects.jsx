...
const Projects = () => {
    ...
    const filteredProjects = categoryData === 'all'
        ? projectsData
        ...
        <div className='projects'>
            <div className="projects-head relative">
                <div className="container">
                    ...
                    <h3 className='text-white-secondary f-bold font-secondary text-center'>Our Completed Projects</h3>
                </div>
                <img className='abouth1' src={aboutbnr1} alt="web developer, web designer,devzone it, devzone it team member, devzone it web service, best web solution agency, bug fixing expert, web agency, frontend developer, backend developer, react developer, full stack web developer, web app, mern, node js, react js, express js, shopify, ecommerce, wordpress, landing design, web software company, digital marketing, graphics design, web developer team, web developer experts, best web agency, web service" />
                <img className='abouth2' src={aboutbnr2} alt="web developer, web designer,devzone it, devzone it team member, devzone it web service, best web solution agency, bug fixing expert, web agency, frontend developer, backend developer, react developer, full stack web developer, web app, mern, node js, react js, express js, shopify, ecommerce, wordpress, landing design, web software company, digital marketing, graphics design, web developer team, web developer experts, best web agency, web service" />
            </div>
            <div className="project-data">
                <div className="container">
                    <div className="tabs">
                        <button onClick={() => { setCategory("all"); setCurrentPage(1) }} className={categoryData == "all" ? "active btn-primary" : "btn-secondary"}>All</button>
                        <button onClick={() => { setCategory("ux/ui"); setCurrentPage(1) }} className={categoryData == "ux/ui" ? "active btn-primary" : "btn-secondary"}>React JS</button>
                        <button onClick={() => { setCategory("web-design"); setCurrentPage(1) }} className={categoryData == "web-design" ? "active btn-primary" : "btn-secondary"}>Next JS</button>
                        <button onClick={() => { setCategory("web-development"); setCurrentPage(1) }} className={categoryData == "web-development" ? "active btn-primary" : "btn-secondary"}>WordPress</button>
                        <button onClick={() => { setCategory("graphic"); setCurrentPage(1) }} className={categoryData == "graphic" ? "active btn-primary" : "btn-secondary"}>Shopify</button>
                    </div>

                    <div className="projects-content">
                        {currentItems.map((item, i) => (
                            <Link to={`/project/${item.id}`} className='projects-card' key={i}>
                                <img src={item.img} alt="web developer" />
